...
class IDLProblemDetector {
    constructor(connection, documents, manager, helper) {
        this.problems = {};
                        ...
                        case ref.symbol.detail.includes("(class definition)"):
                            if (this.helper.procedures[ref.symbol.name.toLowerCase()]) {
                                ...
                                this.problems[ref.uri].push({
                                    ...
                                    message: "Duplicate object definition conflicts with existing, core ENVI + IDL object",
                        ...
                        case ref.symbol.detail.includes("Function"):
                            if (this.helper.functions[ref.symbol.name.toLowerCase()]) {
                                ...
                                this.problems[ref.uri].push({
                                    severity: vscode_languageserver_1.DiagnosticSeverity.Error,
                                    range: ref.symbol.range,
                                    message: "Duplicate function definition conflicts with existing, core ENVI + IDL function",
                                    source: "Internal or core ENVI + IDL"
                                });
                            }
                            break;
                        ...
                        case ref.symbol.detail.includes("Procedure"):
                            if (this.helper.procedures[ref.symbol.name.toLowerCase()]) {
                                ...
                                this.problems[ref.uri].push({
                                    severity: vscode_languageserver_1.DiagnosticSeverity.Error,
                                    range: ref.symbol.range,
                                    message: "Duplicate procedure definition conflicts with existing, core ENVI + IDL procedure",
                                    source: "Internal or core ENVI + IDL"
                                });
                            }
                            break;
