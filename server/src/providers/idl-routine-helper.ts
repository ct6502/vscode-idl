...
import { IDL } from './idl';
import { NORMAL_SEARCH_OPTIONS } from './idl-routine-helper.interface';
import { ISelectedWord } from './idl-symbol-extractor.interface';
...
export class IDLRoutineHelper {
  ...
  completion(
    query: ISelectedWord,
    optimized = false,
    searchOptions = NORMAL_SEARCH_OPTIONS
  ): CompletionItem[] {
